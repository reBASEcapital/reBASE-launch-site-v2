...
var svg = d3.select(".algoslice").append("svg")
    .attr("width", width)
    .attr("height", height)
...
svg.selectAll(".arc")
  ...
  .append("path")
    .attr("fill", /*function(d, i) { return color(i); }*/ "#0085c4")
    .attr("d", arc);
...
function resize() {
  ...
  var width = parseInt(d3.select(".algoslice").style("width")) - margin*2;
  var height = parseInt(d3.select(".algoslice").style("height")) - margin*2;
